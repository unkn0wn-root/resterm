...
type StatusBarPalette struct {
	...
	TestsPass  StatusBarSegmentStyle
	TestsFail  StatusBarSegmentStyle
	TestsError StatusBarSegmentStyle
...
func DefaultStatusBarPalette() StatusBarPalette {
	return StatusBarPalette{
		...
		TestsPass:  StatusBarSegmentStyle{Foreground: "#ECFEFF", Background: "#0E7490"},
		TestsFail:  StatusBarSegmentStyle{Foreground: "#FFF1F2", Background: "#BE123C"},
		TestsError: StatusBarSegmentStyle{Foreground: "#FAF5FF", Background: "#7E22CE"},
