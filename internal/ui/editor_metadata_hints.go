...
var metadataHintCatalog = []metadataHintOption{
	...
	{Label: "@graphql-variables", Aliases: []string{"@variables"}, Summary: "Provide GraphQL variables (JSON)"},
	{Label: "@graphql-query", Aliases: []string{"@query"}, Summary: "Inline a GraphQL query"},
...
func filterMetadataHintOptions(query string) []metadataHintOption {
	if query == "" {
		return cloneMetadataHintOptions(metadataHintCatalog)
	}
