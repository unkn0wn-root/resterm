...
func TestTraceEnabled(t *testing.T) {
	...
	tl := &nettrace.Timeline{
		...
		Phases: []nettrace.Phase{
			...
			{Kind: nettrace.PhaseReqHdrs, Start: t0.Add(45 * time.Millisecond), End: t0.Add(46 * time.Millisecond), Duration: time.Millisecond},
		...
		Details: &nettrace.TraceDetails{
			...
			TLS: &nettrace.TLSDetails{
				...
				Certificates: []nettrace.TLSCert{{Subject: "example.com", Issuer: "Example CA", NotAfter: t0.Add(24 * time.Hour), Serial: "01"}},
			},
		},
	}
	bud := nettrace.Budget{
